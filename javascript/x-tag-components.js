...
/*** X-Tag Object Definition ***/
  ...
  var xtag = {
    ...
    _removeClass: function (element, klass) {
    ...
    toggleClass: function (element, klass) {
      return xtag[xtag._hasClass(element, klass) ? '_removeClass' : '_addClass'].call(null, element, klass);
    },
  ...
  xtag.register('x-map', {
    lifecycle:{
      created: function() {
        ...
        'zoomend','layeradd','layerremove','locationfound','dragData','dragend',
        ...
        set: function(value){
          ...
          (this.getAttribute('for') || '').split(' ').map(function(id){
            ...
            if (index == -1){
              ...
              if (element){
                xtag._removeClass(element, this.id);
      ...
      'id': {
        ...
        set: function(value){
          ...
          xtag.query(document, '.' + current).forEach(function(node){
            xtag._removeClass(node, current);
            xtag._addClass(node, id);
          });
        }
      }
    }
